  ...
  rules: {
    rule_pm_moderate: {
      ...
      timing: {
        ...
        weatherAdjustments: [
          {
            feature: 'inversionPresent',
            condition: 'true',
            shiftStartMinutes: 120,
            shiftEndMinutes: -60,
            rationaleTag: 'avoid_inversion',
          },
          {
            feature: 'humidityLayering',
            condition: 'uniform_humid',
            shiftStartMinutes: 0,
            shiftEndMinutes: -90,
            rationaleTag: 'high_humidity_persistence',
          },
          {
            feature: 'windShearProxy',
            condition: 'high',
            shiftStartMinutes: 0,
            shiftEndMinutes: -60,
            rationaleTag: 'spray_drift_risk',
          },
        ],
      },
      editablePaths: [
    ...
    rule_heat_moderate: {
      ...
      action: {
        type: 'irrigate',
        instructions:
          'Schedule short-cycle irrigation and canopy cooling check.',
      },
      timing: {
        baseWindowHours: {
          startOffsetHours: 10,
        ...
        weatherAdjustments: [
          {
            feature: 'heatStressScore',
            condition: '> 0.7',
            shiftStartMinutes: -60,
            shiftEndMinutes: 0,
            rationaleTag: 'high_heat_stress',
          },
        ],
      },
      editablePaths: [
